...
def get_dataset():
    """Returns the CIFAR10 dataset as a tuple of (train_dataset, test_dataset)
    ...
    """
    train_dataset = torchvision.datasets.CIFAR10(root=DATA_FOLDER_PATH, train=True, transform=transforms.ToTensor(),
                                                 download=True)
    test_dataset = torchvision.datasets.CIFAR10(root=DATA_FOLDER_PATH, train=False, transform=transforms.ToTensor(),
                                                download=True)
